	...
	function loadWeatherData() {
		$.ajax({
			...
			success: function(data2) {
				...
				if (fTemp > 40.0) {
					$('body').css('background-image', 'url("https://images.unsplash.com/photo-1445964047600-cdbdb873673d?ixlib=rb-0.3.5&s=bceffd8bfff0b56d3de82e4e59528a60&auto=format&fit=crop&w=2956&q=80") ');
				} else if (fTemp > 70.0) {
